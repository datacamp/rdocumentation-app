...
module.exports.routes = {
  ...
  //***** PackageVersion *****
    ...
    'get r|\/api\/packages\/([^\/]+)\/versions\/([^\/]+)\/source|name,version,filename': 'PackageVersionController.getSourceTree',
    ...
    'get r|^\/packages\/([^\/]+)\/versions\/([^\/]+)\/source|name,version': 'PackageVersionController.getSource',
  //***** /PackageVersion *****
