    ...
    classMethods: {
      ...
      */
      ...
      quickSearch: function(pattern){
        ...
        " WHERE (downloads.date >= current_date() - interval '1' month or downloads.date is null) and coll.name LIKE '%"+pattern+"%' group by coll.name order by total desc limit 0,4";
